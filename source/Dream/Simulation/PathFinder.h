...
namespace Dream {
	namespace Simulation {
		...
		*/
		...
		public:
			PathFinder (const StepT& start_location, const StepT& end_location, InterfaceT* interface) : _start_location(start_location), _end_location(end_location), _interface(interface) {
